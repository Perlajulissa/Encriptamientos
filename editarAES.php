...
function desifradoAES($passW, $llave, $inivec){
  ...
  return openssl_decrypt($passW, 'aes-256-cbc', $llave, false,);
}
...
<center>
<form method="Post" action = "algoritmo_AES.php">  
 ...
 <center><label>Cifrado simétrico AES</label><center>
            ...
            <label for="floatingid_type">id_tipo</label>
                ...
                <input type="number" name="id_tipo" class="form-control" id="floatingid_type" placeholder="id_tipo" value="1">  
            </div>
            <div><button class="w-100 btn btn-lg btn-primary" type="submit">Actualizar</button></div>
        
        </form>
<center>
    <br><a type="submit" class="w-100 btn btn btn-lg btn btn-info " href="consultarAES.php">Consultar datos</a></br>
