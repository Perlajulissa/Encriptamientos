...
<form method="Post" action = "algoritmoCRC32.php">  
            ...
            <label for="floatingid_type">id_tipo</label>
                ...
                <input type="number" name="id_tipo" class="form-control" id="floatingid_type" placeholder="id_tipo" value="5">  
            </div>
          <div><button class="w-100 btn btn-lg btn-primary" type="submit">Actualizar</button></div>
          <br><a type="submit" class="w-100 btn btn btn-lg btn btn-info " href="consultarCRC32.php">Consultar datos</a></br>
