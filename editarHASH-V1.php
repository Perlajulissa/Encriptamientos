...
function desifradoHASH($password){
...
<form method="Post" action = "algoritmoHASH-V1.php">  

 <center><label>Cifrado HASH-V1</label><center>
            ...
            <label for="floatingid_type">id_tipo</label>
                ...
                <input type="number" name="id_tipo" class="form-control" id="floatingid_type" placeholder="id_tipo" value="3">  
            </div>
  ...
  <center>
    ...
    <br><a type="submit" class="w-100 btn btn btn-lg btn btn-info " href="consultarHASH-V1.php">Consultar datos</a></br>
</body>
