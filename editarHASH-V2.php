...
function desifradoHASHV2($password){
...
<head>
    ...
    <title>Formulario HASH-V1</title>
...
<form method="Post" action = "algoritmoHASH-V2.php">  

 <center><label>Cifrado HASH-V2</label><center>
            ...
            <label for="floatingid_type">id_tipo</label>
                ...
                <input type="number" name="id_tipo" class="form-control" id="floatingid_type" placeholder="id_tipo" value="4">  
            </div>
  ...
  <center>
    ...
    <br><a type="submit" class="w-100 btn btn btn-lg btn btn-info " href="consultarHASH-V2.php">Consultar datos</a></br>
</body>
